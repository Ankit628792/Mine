...
const CardComponent = ({ cardData }) => {
  const cardHeight = windowHeight - 220;
  ...
  return (
    <View
      ...
      <Image
        ...
        resizeMode='cover'
      />
      <View style={tw`absolute inset-0 bottom-1 bg-purple-800 rounded-xl bg-opacity-30 `}>

        <LinearGradient
          colors={['rgba(128,102,255,0.5)', 'rgba(0,0,0,0)']}
          ...
          <View style={tw`p-5`}>
            ...
            <View style={tw`bg-white bg-opacity-50 rounded-full py-1.5 px-3 mt-2 mr-auto flex-row items-center gap-1`}>
              ...
              <Text style={tw`text-sm font-medium relative tracking-tight text-white`}>{cardData?.distance || 0} Km away</Text>
            </View>
          </View>
        </LinearGradient>
      </View>
