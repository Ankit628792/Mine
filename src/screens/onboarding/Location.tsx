        ...
        <>
            ...
            <LinearGradient colors={gradient.bg} style={tw`flex-1 p-5 flex-col justify-between`}>
                ...
                <View style={tw`flex-grow py-5`}>
                    <Text style={[tw`text-3xl font-medium text-center`, { color: colors.black }]}>Location Range</Text>
                    <View style={tw`flex-1 justify-center items-stretch my-8 relative`}>
                        <MultiSlider
                            ...
                            markerStyle={{ backgroundColor: colors.blue, width: 20, height: 20, marginTop: 4 }}
...
const CustomMarker = (props) => {
    return (
        <View style={tw`mt-8 z-20 w-24 flex-col items-center`}>
            <View style={[tw`w-5 h-5 rounded-full`, { backgroundColor: colors.blue }]}></View>
