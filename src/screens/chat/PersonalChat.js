    ...
    <TouchableHighlight
      ...
      <>
        ...
        <View
          ...
          <View
            style={tw`p-2 ${mine ? 'bg-gray-100 bg-opacity-15' : 'bg-gray-800 bg-opacity-75'
              } rounded-xl max-w-[240px] mb-1 ${mine ? 'rounded-tr-0' : 'rounded-tl-0'
              }`}>
          ...
          <Text
            style={tw`text-gray-200 absolute -bottom-4 z-20 w-[200px] text-xs ${mine ? 'text-right right-0' : 'text-left left-0'
              } ${next ? '' : 'hidden'}`}>
