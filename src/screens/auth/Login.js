...
const Login = ({ route }) => {
    ...
    return (
        <>
            <LinearGradient style={tw`flex-1 flex-col justify-between relative`} colors={gradient.orange} >
                ...
                >
                    ...
                    <View nativeID=' jyg' style={tw`bg-gray-50 p-5 rounded-lg w-full h-9/10 relative`}>
                        <TouchableOpacity onPress={() => setIsOpen(false)}>
                            <Svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={tw`w-8 h-8 text-gray-800 ml-auto`}>
